...
int main(int argc, char **argv)
{
    ...
    check_status(nvgraphGetVertexData(handle, graph, (void*)sssp_1_h, 0, NVGRAPH_CSC_32));
    ...
    check_status(nvgraphGetVertexData(handle, graph, (void*)sssp_2_h, 1, NVGRAPH_CSC_32));
